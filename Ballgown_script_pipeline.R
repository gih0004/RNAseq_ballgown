...
list.files()
list.files("ballgown/")#you want to note this order of files in the ballgown folder that you have donwloaded from HPC. Now in the .csv file, it should be the same order.
